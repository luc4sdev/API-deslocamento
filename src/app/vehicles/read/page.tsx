...
export default function Read() {
    ...
    async function getAllData() {
        const data = await fetchAllData('https://api-deslocamento.herokuapp.com/api/v1/Veiculo');
        setVehicles(data)
    }
            ...
            {vehicles.length === 0 ?
                ...
                <Box sx={{
                    ...
                    <Box sx={{ backgroundColor: 'primary.main', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Typography fontSize={30} textAlign={'center'}>Visualizar veículos</Typography>
                    </Box>
